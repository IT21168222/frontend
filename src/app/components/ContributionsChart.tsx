...
//   const classCount = contributions[features[0]].length;

//   const data = {
//     labels: features
//       .map((feature) => feature)
//       .filter((feature) => feature !== "Failure_Type"),
//     datasets: Array.from({ length: classCount }, (_, i) => ({
//       label: `Class ${i}`,
//       data: features.map((feature) => contributions[feature][i]),
//       backgroundColor: `rgba(${100 + i * 50}, ${150 - i * 30}, ${
//         200 - i * 20
//       }, 0.5)`,
//       borderColor: `rgba(${100 + i * 50}, ${150 - i * 30}, ${200 - i * 20}, 1)`,
//       borderWidth: 1,
//     })),
//   };
